<section>
    ...
    <p>
    	پشتیبانی ساکنین: 09122490804
    </p>
    <p>
    	بازاریابی: 09122490804
    </p>
    <p>
    	فکس: ........................
    </p>
    <p>
    	info@pelakprestige.com   
    </p>
    <p>
    	در صورت تمایل می توانید با تکمیل فرم زیر منتظر تماس ما باشید:
    </p>
    <form id="contact-form" role="form" method="post">
    	<div class="form-group name">
            <label for="name">نام ساختمان یا مجتمع شما (در صورت وجود )</label>
