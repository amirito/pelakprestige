<h3 align="justify" class="blue">	پلاک پرستیژ ارزش افزوده ای بر ساختمان شما!</h3>
<div align="justify">
  <ul class="list-unstyled">
    ...
    <li><i class="fa fa-arrow-circle-left"></i><span dir="RTL"> </span>برگزاری مراسم،  تشریفات، خدمات جانبی اماکن ورزشی، ایمنی وبهداشت</li>
    <li><i class="fa fa-arrow-circle-left"></i><span dir="RTL"> </span>انجام امور پیمانی  مربوط به تمام یا بخشی از مجتمع</li>
    <li><i class="fa fa-arrow-circle-left"></i><span dir="RTL"> </span>برنامه ریزی های  عمومی مجتمع</li>
    <li><i class="fa fa-arrow-circle-left"></i><span dir="RTL"> </span>استانداردسازی  خدمات ارائه شده موجود</li>
    <li><i class="fa fa-arrow-circle-left"></i><span dir="RTL"> </span>برگزاری دوره های  مختلف عمومی و تخصصی هوشمند ویژه مدیروپرسنل <span dir="LTR"> </span></li>
    <li><i class="fa fa-arrow-circle-left"></i><span dir="RTL"> </span>گزارش دهی آنی ،هفتگی،  ماهانه و سالیانه به مجمع و همچنین به صورت تکی به واحدها</li>
  </ul>
